  ...
  <div class="row g-5">
    ...
    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
      <div class="specialty-card">
        ...
        <div class="specialty-visual">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/health/cardiology-1.webp" alt="Cardiovascular Medicine" class="img-fluid">
    ...
    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
      <div class="specialty-card">
        ...
        <div class="specialty-visual">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/health/neurology-4.webp" alt="Neurological Sciences" class="img-fluid">
          <div class="visual-overlay">
            <i class="bi bi-cpu"></i>
          </div>
        </div>
